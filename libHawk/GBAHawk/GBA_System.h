...
namespace GBAHawk
{
	...
	#pragma region ARM7_TDMI
		...
		const static uint16_t cpu_ARM_Bx = 19;
		const static uint16_t cpu_ARM_MUL = 20;
		const static uint16_t cpu_ARM_MUL_UL = 21;
		const static uint16_t cpu_ARM_MUL_SL = 22;
		const static uint16_t cpu_ARM_Swap = 23;
		const static uint16_t cpu_ARM_Imm_LS = 24;
		const static uint16_t cpu_ARM_Reg_LS = 25;
		const static uint16_t cpu_ARM_Multi_1 = 26;
		const static uint16_t cpu_ARM_Branch = 27;
		const static uint16_t cpu_ARM_Cond_Check_Only = 28;

		const static uint16_t cpu_ARM_AND_LDM = 50;
		const static uint16_t cpu_ARM_EOR_LDM = 51;
		const static uint16_t cpu_ARM_SUB_LDM = 52;
		const static uint16_t cpu_ARM_RSB_LDM = 53;
		const static uint16_t cpu_ARM_ADD_LDM = 54;
		const static uint16_t cpu_ARM_ADC_LDM = 55;
		const static uint16_t cpu_ARM_SBC_LDM = 56;
		const static uint16_t cpu_ARM_RSC_LDM = 57;
		const static uint16_t cpu_ARM_TST_LDM = 58;
		const static uint16_t cpu_ARM_TEQ_LDM = 59;
		const static uint16_t cpu_ARM_CMP_LDM = 60;
		const static uint16_t cpu_ARM_CMN_LDM = 61;
		const static uint16_t cpu_ARM_ORR_LDM = 62;
		const static uint16_t cpu_ARM_MOV_LDM = 63;
		const static uint16_t cpu_ARM_BIC_LDM = 64;
		const static uint16_t cpu_ARM_MVN_LDM = 65;
		const static uint16_t cpu_ARM_MSR_LDM = 66;
		const static uint16_t cpu_ARM_MSR_LDM_Glitchy = 67;
		const static uint16_t cpu_ARM_MRS_LDM = 68;
		const static uint16_t cpu_ARM_Bx_LDM = 69;
		const static uint16_t cpu_ARM_MUL_LDM = 70;
		const static uint16_t cpu_ARM_MUL_UL_LDM = 71;
		const static uint16_t cpu_ARM_MUL_SL_LDM = 72;
		const static uint16_t cpu_ARM_Swap_LDM = 73;
		const static uint16_t cpu_ARM_Imm_LS_LDM = 74;
		const static uint16_t cpu_ARM_Reg_LS_LDM = 75;
		const static uint16_t cpu_ARM_Multi_1_LDM = 76;
		const static uint16_t cpu_ARM_Branch_LDM = 77;
		const static uint16_t cpu_ARM_Cond_Check_Only_LDM = 78;
