...
namespace GBHawk
{
	...
	void GB_System::cpu_Execute_Internal_Only_ARM()
	{
	...
	void GB_System::cpu_Execute_Internal_Only_TMB()
	{
		int ofst = 0;
	...
	void GB_System::cpu_LDM_Glitch_Decode_ARM()
	{
		switch ((cpu_Instr_ARM_2 >> 25) & 7)
		{
			case 0:
