...
namespace NESHawk
{
	...
	void NES_System::cpu_ALU_Operation()
	{
		switch (cpu_ALU_Type)
		{
			case ALU::NOP:
	...
	void NES_System::cpu_Write_Operation()
	{
		switch (cpu_ALU_Type)
		{
			case ALU::STA:
	...
	void NES_System::Execute(int cycles)
	{
	...
	void NES_System::Fetch_Opcode_No_Interrupt()
	{
	...
	void NES_System::Fetch_Dummy_Interrupt()
	{
