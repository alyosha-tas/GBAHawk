...
namespace BizHawk.Bizware.BizwareGL
{
	...
	{
		private const string EMBED_PREFIX = "BizHawk.Bizware.BizwareGL.";

		private static Type[]? _types = null;

		private static readonly Assembly Asm = typeof(BizHawk.Bizware.BizwareGL.ReflectionCache).Assembly;
