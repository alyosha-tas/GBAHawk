...
namespace BizHawk.Client.Common.movie.import
{
	...
	internal class VbmImport : MovieImporter
	{
		protected override void RunImport()
		{
			...
			*/
			...
			if (isGBA)
			{
				...
				Result.Movie.SyncSettingsJson = ConfigService.SaveWithType(new GBAHawk.GBASyncSettings { });
			}
			else
			{
				...
				switch (Config.PreferredCores[VSystemID.Raw.GB])
				{
					...
					case CoreNames.SubGBHawk:
						...
						{
							ConsoleMode = GBHawk.GBSyncSettings.ConsoleModeType.GBC,
						});
						break;
				}
			}
		...
		private static SimpleController GbaController()
			=> new(new ControllerDefinition("Gameboy Advance Controller")
			{
