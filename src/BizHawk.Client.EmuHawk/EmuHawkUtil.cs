...
namespace BizHawk.Client.GBAHawk
{
	public static class EmuHawkUtil
	{
		...
		{
			if (filename.Contains("|") || !".lnk".Equals(Path.GetExtension(filename), StringComparison.InvariantCultureIgnoreCase)) return filename; // archive internal files are never shortcuts (and choke when analyzing any further)
