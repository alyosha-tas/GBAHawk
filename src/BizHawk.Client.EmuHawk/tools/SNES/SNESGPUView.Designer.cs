namespace BizHawk.Client.GBAHawk
{
	partial class SNESGpuView
	{
		...
		private void InitializeComponent()
		{
			...
			this.Name = "SNESGpuView";
			this.SizeGripStyle = System.Windows.Forms.SizeGripStyle.Show;
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.SNESGpuView_FormClosed);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.SNESGpuView_KeyDown);
