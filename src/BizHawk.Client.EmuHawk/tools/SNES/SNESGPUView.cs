...
namespace BizHawk.Client.GBAHawk
{
	[SpecializedTool("SNES GPU Viewer")]
	public partial class SNESGpuView : ToolFormBase, IToolFormAutoConfig
	{
		[RequiredService]
		private ISNESGPUViewable SNES { get; set; }
		...
		protected override string WindowTitleStatic => "SNES GPU Viewer";

		public SNESGpuView()
		{
			InitializeComponent();
			Icon = Properties.Resources.TvIconIco;
		...
		protected override void UpdateBefore()
		{
			...
			if (_cbScanlineEmu != _cbScanline)
			{
				...
				{
					SNES.SetScanlineCallback(null, 0);
				}
				else
				{
					SNES.SetScanlineCallback(DrawEverything, _cbScanline.Value);
				}
			}
		}
		...
		private void SNESGpuView_FormClosed(object sender, FormClosedEventArgs e)
		{
			SNES?.SetScanlineCallback(null, 0);
		}
		...
		private void SNESGpuView_KeyDown(object sender, KeyEventArgs e)
		{
