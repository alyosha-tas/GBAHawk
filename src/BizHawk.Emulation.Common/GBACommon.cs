	...
	public class GBACommonFunctions
	{
		...
		public static bool EEPROM_512_check(string romHashSHA1)
		{
			if ((romHashSHA1 == "SHA1:D3C3201F4A401B337009E667F5B001D5E12ECE83") || // Shrek 2 (USA)
				...
				(romHashSHA1 == "SHA1:AF2B2206777651C7993C1AE9008D07C31430207E") || // Doom (USA, Europe)
				(romHashSHA1 == "SHA1:2FEEFFC96386CF2CC0B2076928B010F18E9E9748") || // Doom II (USA)
				(romHashSHA1 == "SHA1:38C7BAFDC2E6D7B9700385C01FBEF6B6888E4A33") || // Doom II (Europe)
