...
{
	/// <summary>
	/// static bindings into N64Hawk.dll
	/// </summary>
	public static class LibN64Hawk
	{
		private const string lib = "N64Hawk";
		private const CallingConvention cc = CallingConvention.Cdecl;

		/// <returns>opaque state pointer</returns>
		[DllImport(lib, CallingConvention = cc)]
		public static extern IntPtr N64_create();

		/// <param name="core">opaque state pointer</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_destroy(IntPtr core);
		...
		/// <returns>0 on success, negative value on failure.</returns>
		[DllImport(lib, CallingConvention = cc)]
		public static extern int N64_create_SRAM(IntPtr core, byte[] sram_data, uint length);
		...
		/// <returns>0 on success, negative value on failure.</returns>
		[DllImport(lib, CallingConvention = cc)]
		public static extern int N64_load_SRAM(IntPtr core, byte[] sram_data, uint length);
		...
		/// <returns>0 on success, negative value on failure.</returns>
		[DllImport(lib, CallingConvention = cc)]
		public static extern int N64_load_Palette(IntPtr core, int[] palette);
		...
		/// <returns>0 on success, negative value on failure.</returns>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_Hard_Reset(IntPtr core);
		...
		/// <returns>0 on success, negative value on failure.</returns>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_Soft_Reset(IntPtr core);
		...
		public static extern bool N64_frame_advance(IntPtr core, bool render, bool sound);
		...
		/// <param name="core">opaque state pointer</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern ulong N64_get_cycles(IntPtr core);
		...
		[DllImport(lib, CallingConvention = cc)]
		[return: MarshalAs(UnmanagedType.I1)]
		public static extern bool N64_subframe_advance(IntPtr core, bool render, bool sound, bool do_reset, uint reset_cycle);
		...
		/// <param name="core">opaque state pointer</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern ulong N64_subframe_cycles(IntPtr core);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_setcontrollercallback(IntPtr core, ControllerReadCallback callback);
		...
		/// <param name="callback">null to clear</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_setstrobecallback(IntPtr core, ControllerStrobeCallback callback);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_get_video(IntPtr core, int[] videobuf);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern uint N64_get_audio(IntPtr core, int[] aud_buf, ref uint n_samp);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_save_state(IntPtr core, byte[] saver);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_load_state(IntPtr core, byte[] loader);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getsysbus(IntPtr core, int addr);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getvram(IntPtr core, int addr);
		...
		/// <param name="addr">vram address</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getchrrom(IntPtr core, int addr);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getram(IntPtr core, int addr);
		...
		/// <param name="addr">ram address</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getrom(IntPtr core, int addr);
		...
		/// <param name="addr">vram address</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getoam(IntPtr core, int addr);
		...
		/// <param name="addr">vram address</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getpalram(IntPtr core, int addr);
		...
		/// <param name="addr">ram address</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern byte N64_getsram(IntPtr core, int addr);
		...
		/// <param name="callback">null to clear</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_settracecallback(IntPtr core, TraceCallback callback);
		...
		/// <param name="core">opaque state pointer</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern int N64_getheaderlength(IntPtr core);
		...
		/// <param name="core">opaque state pointer</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern int N64_getdisasmlength(IntPtr core);
		...
		/// <param name="core">opaque state pointer</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern int N64_getregstringlength(IntPtr core);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_getheader(IntPtr core, StringBuilder h, int l);
		...
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_getregisterstate(IntPtr core, StringBuilder h, int t, int l);
		...
		/// <param name="l">copy length, must be obtained from appropriate get legnth function</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_getdisassembly(IntPtr core, StringBuilder h, int t, int l);
		...
		/// <param name="callback">null to clear</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_setmessagecallback(IntPtr core, MessageCallback callback);
		...
		/// <param name="h">pointer to const char *</param>
		[DllImport(lib, CallingConvention = cc)]
		public static extern void N64_getmessage(IntPtr core, StringBuilder h);
