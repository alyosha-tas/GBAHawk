...
namespace BizHawk.Emulation.Common
{
	...
	{
		private const string EMBED_PREFIX = "BizHawk.Emulation.Common.";

		private static Type[]? _types = null;

		private static readonly Assembly Asm = typeof(BizHawk.Emulation.Common.ReflectionCache).Assembly;
