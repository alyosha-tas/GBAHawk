...
{
	public partial class GBA : IEmulator, ISoundProvider, IVideoProvider
	{
		...
		public bool FrameAdvance(IController controller, bool render, bool rendersound)
		{
			...
			LibGBA.GBA_settracecallback(GBA_Pntr, tracecb);
			...
			LibGBA.GBA_frame_advance(GBA_Pntr, cont_result, true, true);

			LibGBA.GBA_get_video(GBA_Pntr, _vidbuffer);
		...
		{
			uint f_clock = LibGBA.GBA_get_audio(GBA_Pntr, Aud_L, ref num_samp_L, Aud_R, ref num_samp_R);
