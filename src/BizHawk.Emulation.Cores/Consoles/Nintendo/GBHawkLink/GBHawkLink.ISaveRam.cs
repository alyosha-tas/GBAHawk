	...
	public partial class GBHawkLink : ISaveRam
	{
		public byte[] CloneSaveRam()
		{
			if (cart_RAMS[0] != null || cart_RAMS[1] != null)
			{
				...
				if (cart_RAMS[0] != null)
				{
					...
					{
						cart_RAMS[0][i] = LibGBHawkLink.GBLink_getsram(GB_Pntr, i, 0);
					}		
				}
				...
				if (cart_RAMS[1] != null)
				{
					...
					{
						cart_RAMS[1][i] = LibGBHawkLink.GBLink_getsram(GB_Pntr, i, 1);
					}
				}
		...
		public void StoreSaveRam(byte[] data)
		{
			if (cart_RAMS[0] != null && cart_RAMS[1] == null)
			{
				...
				LibGBHawkLink.GBLink_load_SRAM(GB_Pntr, cart_RAMS[0], (uint)cart_RAMS[0].Length, 0);
			}
			else if (cart_RAMS[1] != null && cart_RAMS[0] == null)
			{
				Buffer.BlockCopy(data, 0, cart_RAMS[1], 0, cart_RAMS[1].Length);

				LibGBHawkLink.GBLink_load_SRAM(GB_Pntr, cart_RAMS[1], (uint)cart_RAMS[1].Length, 1);
			}
			else if (cart_RAMS[1] != null && cart_RAMS[0] != null)
			{
				Buffer.BlockCopy(data, 0, cart_RAMS[0], 0, cart_RAMS[0].Length);
