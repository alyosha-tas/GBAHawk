...
namespace BizHawk.Emulation.Cores.Nintendo.GBHawkLink4x
{
	...
	public partial class GBHawkLink4x : IEmulator, ISaveRam, IStatable, IInputPollable, IRegionable,
	ISettable<GBHawkLink4x.GBLink4xSettings, GBHawkLink4x.GBLink4xSyncSettings>
	{
		...
		public GBHawkLink4x(CoreLoadParameters<GBLink4xSettings, GBLink4xSyncSettings> lp)
		{
			...
			B.is_multi_core = true;
			C.is_multi_core = true;
			D.is_multi_core = true;
		...
		public ulong TotalExecutedCycles => A.cpu.TotalExecutedCycles;
