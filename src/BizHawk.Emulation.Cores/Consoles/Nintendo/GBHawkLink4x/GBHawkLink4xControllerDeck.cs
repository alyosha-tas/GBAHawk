...
namespace BizHawk.Emulation.Cores.Nintendo.GBHawkLink4x
{
	...
	{
		public GBHawkLink4xControllerDeck(string controller1Name, string controller2Name, string controller3Name, string controller4Name, bool only_3_roms)
		{
			...
			else
			{
				Definition = new ControllerDefinition(Port1.Definition.Name)
				{
					BoolButtons = Port1.Definition.BoolButtons
						...
						.Concat(Port4.Definition.BoolButtons)
						.Concat(new[] { "Toggle Cable LR" })
						.Concat(new[] { "Toggle Cable RC" })
						.Concat(new[] { "Toggle Cable CL" })
						.ToList()
				}.MakeImmutable();
			}
		}
