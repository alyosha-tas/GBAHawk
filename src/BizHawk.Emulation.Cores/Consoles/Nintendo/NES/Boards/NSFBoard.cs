...
namespace BizHawk.Emulation.Cores.Nintendo.NES
{
	...
	internal sealed class NSFBoard : NesBoardBase
	{
		...
		public override void AtVsyncNmi()
		{
			...
			bool a = ((justDown >> 7) & 1) == 1;
			bool b = ((justDown >> 6) & 1) == 1;
			bool sel = ((justDown >> 5) & 1) == 1;
			bool start = ((justDown >> 4) & 1) == 1;
			bool up = ((justDown >> 3) & 1) == 1;
			bool down = ((justDown >> 2) & 1) == 1;
			bool left = ((justDown >> 1) & 1) == 1;
			bool right = ((justDown >> 0) & 1) == 1;
