...
namespace BizHawk.Emulation.Cores.Nintendo.NES
{
	...
	{		
		...
		{
			return MOS6502X_DISASM.Disassemble(pc, out bytesToAdvance, Core.PeekMemory);
		}
		...
		{
			return MOS6502X_DISASM.Disassemble((ushort)addr, out length, a => m.PeekByte((int)a));
		}
	}

	public static class MOS6502X_DISASM
	{
