...
namespace BizHawk.Emulation.Cores.Nintendo.NES
{
	...
	public partial class NES : IEmulator, ISaveRam, IInputPollable, IRegionable,
		IBoardInfo, IRomInfo, ISettable<NES.NESSettings, NES.NESSyncSettings>
	{
		...
		private static NESSyncSettings.Region DetectRegion(string system)
		{
			...
			{
				case "NES-NTSC":
					return NESSyncSettings.Region.NES;
				case "Famicom":
					return NESSyncSettings.Region.FAM;
				case null:
