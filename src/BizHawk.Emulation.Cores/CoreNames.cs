...
namespace BizHawk.Emulation.Cores
{
	...
	{
		public const string NESHawk2 = "NESHawk2";
		public const string SNESHawk = "NESHawk";
		public const string N64Hawk = "N64Hawk";
		public const string SubNESHawk2 = "SubNESHawk2";
