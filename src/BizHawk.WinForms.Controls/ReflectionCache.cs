...
namespace BizHawk.WinForms.Controls
{
	...
	{
		private const string EMBED_PREFIX = "BizHawk.WinForms.Controls.";

		private static Type[]? _types = null;

		private static readonly Assembly Asm = typeof(BizHawk.WinForms.Controls.ReflectionCache).Assembly;
